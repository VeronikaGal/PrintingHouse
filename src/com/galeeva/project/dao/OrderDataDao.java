...
public class OrderDataDao implements Dao<Long, OrderDataEntity> {
    ...
    public OrderDataEntity save(OrderDataEntity orderData) {
        try (var connection = ConnectionManager.get();
            ...
            prepareStatement.setObject(1, orderData.getUserId());
            prepareStatement.setObject(2, orderData.getServiceId());
            prepareStatement.setObject(3, orderData.getFile());
            prepareStatement.setObject(4, String.valueOf(orderData.getPaperType()));
            prepareStatement.setObject(5, orderData.getQuantity());
            prepareStatement.setObject(6, orderData.getMachineId());
            prepareStatement.setObject(7, String.valueOf(orderData.getStatus()));
            prepareStatement.setObject(8, orderData.getTotalPrice());
            prepareStatement.setObject(9, Timestamp.valueOf(orderData.getCreatedAt()));
            prepareStatement.setObject(10, orderData.getDeliveredAt());
            prepareStatement.setObject(11, String.valueOf(orderData.getDelivery()));
    ...
    public void update(OrderDataEntity orderData) {
        try (var connection = ConnectionManager.get();
            ...
            prepareStatement.setLong(1, orderData.getUserId());
            prepareStatement.setInt(2, orderData.getServiceId());
    ...
    private OrderDataEntity buildOrderData(ResultSet resultSet) throws SQLException {
        return new OrderDataEntity(
                ...
                resultSet.getObject("users_id", Long.class),
                ...
                resultSet.getObject("machine_id", Integer.class),
                ...
                resultSet.getObject("delivered_at", Timestamp.class).toLocalDateTime(),
